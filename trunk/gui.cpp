       ...
       : wxFrame(NULL, wxID_ANY, title, wxPoint(-1, -1), wxSize(350, 170))
{
	...
	ip = new wxComboBox(panel, wxID_ANY, wxT(""), wxPoint(5, 20), wxSize(264, 25), WXSIZEOF(tabb), tabb);
	port = new wxSpinCtrl(panel, wxID_ANY, wxT("7171"), wxPoint(287, 20), wxSize(50, 25), wxSP_ARROW_KEYS, 1000, 9999, 7171);
	TibiaPid pid;
